import svgPaths from "./svg-1qq29ucjib";
...
function Icon() {
  return (
    <div className="absolute left-[135.97px] size-[48px] top-[24px]" data-name="Icon">
...
function Heading() {
  return (
    <div className="absolute h-[28px] left-[24px] top-[88px] w-[271.953px]" data-name="Heading 2">
      <p className="absolute font-['Raleway:Regular',sans-serif] font-normal leading-[28px] left-[136.16px] text-[#101828] text-[20px] text-center text-nowrap top-0 translate-x-[-50%]">Welcome back!</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[20px] left-[24px] top-[124px] w-[271.953px]" data-name="Paragraph">
      <p className="absolute font-['Raleway:Regular',sans-serif] font-normal leading-[20px] left-[136px] text-[#4a5565] text-[14px] text-center top-0 translate-x-[-50%] w-[272px]">{`You're signed in as info@theinnerface.com`}</p>
    </div>
  );
}

function Container1() {
  return <div className="absolute bg-gradient-to-b from-[rgba(255,255,255,0.4)] h-[40px] left-0 rounded-[3.35544e+07px] to-[rgba(0,0,0,0)] top-0 via-50% via-[rgba(255,255,255,0.1)] w-[271.953px]" data-name="Container" />;
}

function Container2() {
  return <div className="absolute bg-gradient-to-b from-[rgba(255,255,255,0.5)] h-[16px] left-0 rounded-[3.35544e+07px] to-[rgba(0,0,0,0)] top-0 w-[271.953px]" data-name="Container" />;
}

function Text() {
  return (
    <div className="absolute h-[21px] left-[60.03px] top-[9.5px] w-[151.875px]" data-name="Text">
      <p className="absolute font-['Raleway:SemiBold',sans-serif] font-semibold leading-[21px] left-[76px] text-[#101828] text-[14px] text-center text-nowrap top-0 translate-x-[-50%]">Continue to DivinityAGI</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="bg-gradient-to-b from-[#ffd369] h-[40px] overflow-clip relative rounded-[3.35544e+07px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 to-[#ffd369] via-50% via-[#ffc850] w-full" data-name="Button">
      <Container1 />
      <Container2 />
      <Text />
    </div>
...
function Container3() {
  return <div className="absolute bg-gradient-to-b from-[rgba(255,255,255,0.6)] h-[36px] left-[2px] rounded-[3.35544e+07px] to-[rgba(249,250,251,0.3)] top-[2px] via-50% via-[rgba(0,0,0,0)] w-[267.953px]" data-name="Container" />;
}

function Container4() {
  return <div className="absolute bg-gradient-to-b from-[#ffffff] h-[12.594px] left-[2px] rounded-[3.35544e+07px] to-[rgba(0,0,0,0)] top-[2px] w-[267.953px]" data-name="Container" />;
}

function Text1() {
  return (
    <div className="absolute h-[21px] left-[107.59px] top-[9.5px] w-[56.75px]" data-name="Text">
      <p className="absolute font-['Raleway:SemiBold',sans-serif] font-semibold leading-[21px] left-[28.5px] text-[#364153] text-[14px] text-center text-nowrap top-0 translate-x-[-50%]">Sign Out</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[rgba(255,255,255,0.95)] h-[40px] relative rounded-[3.35544e+07px] shrink-0 w-full" data-name="Button">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        <Container3 />
        <Container4 />
        <Text1 />
      </div>
      <div aria-hidden="true" className="absolute border-2 border-[#d1d5dc] border-solid inset-0 pointer-events-none rounded-[3.35544e+07px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" />
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[12px] h-[92px] items-start left-[24px] top-[168px] w-[271.953px]" data-name="Container">
      <Button />
      <Button1 />
    </div>
  );
...
function Container6() {
  return (
    <div className="absolute bg-white border-2 border-[rgba(255,255,255,0.4)] border-solid h-[288px] left-[34.52px] rounded-[24px] shadow-[0px_8px_30px_0px_rgba(0,0,0,0.08)] top-[262.39px] w-[323.953px]" data-name="Container">
      <Icon />
      <Heading />
      <Paragraph />
      <Container5 />
