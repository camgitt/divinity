import svgPaths from "./svg-rcow8f334z";
...
function Container() {
  return <div className="absolute h-[1106.391px] left-0 top-0 w-[393px]" data-name="Container" style={{ backgroundImage: "linear-gradient(109.556deg, rgba(255, 211, 105, 0.1) 0%, rgb(255, 255, 255) 50%, rgba(122, 79, 255, 0.05) 100%)" }} />;
}
...
function Button2() {
  return (
    <div className="absolute bg-gradient-to-b from-[#ffd369] h-[48px] left-0 rounded-[14px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] to-[#ffd369] top-[612px] via-50% via-[#ffc850] w-[309px]" data-name="Button">
      <p className="absolute font-['Raleway:SemiBold',sans-serif] font-semibold leading-[20px] left-[154.98px] text-[#101828] text-[14px] text-center text-nowrap top-[14px] translate-x-[-50%]">Continue</p>
    </div>
  );
}
...
function Container18() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[92px] items-start left-0 top-[700px] w-[309px]" data-name="Container">
      <Container16 />
      <Container17 />
    </div>
  );
...
function Paragraph2() {
  return (
    <div className="absolute h-[22.391px] left-0 top-[816px] w-[309px]" data-name="Paragraph">
...
function Card() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[56px] h-[978.391px] items-start left-0 pl-[26px] pr-[2px] py-[26px] rounded-[24px] top-[64px] w-[361px]" data-name="Card">
...
function Container19() {
  return (
    <div className="absolute h-[1042.391px] left-[16px] top-[32px] w-[361px]" data-name="Container">
      <Button />
      <Card />
    </div>
  );
...
function LandingRegistrationPage5() {
  return (
    <div className="absolute bg-white h-[1106.391px] left-0 overflow-clip top-0 w-[393px]" data-name="LandingRegistrationPage">
      <Container />
      <Container19 />
    </div>
  );
...
function BottomNavigation12() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0.95)] border-[1px_0px_0px] border-[rgba(107,93,211,0.1)] border-solid h-[81px] left-0 shadow-[0px_16px_48px_0px_rgba(107,93,211,0.2)] top-[862px] w-[393px]" data-name="BottomNavigation">
      <Container20 />
      <Container21 />
      <CrisisSupportButton />
    </div>
