import svgPaths from "./svg-j8g69joa3s";
...
function Icon4() {
  return (
    <BackgroundImage1 additionalClassNames="relative shrink-0">
      <path d={svgPaths.p635fea0} id="Vector" stroke="var(--stroke-0, #05DF72)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Icon">
          <path d={svgPaths.p441d680} id="Vector" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
          <path d={svgPaths.p1736140} id="Vector_2" stroke="var(--stroke-0, #90A1B9)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.66667" />
...
function Icon10() {
  return (
    <BackgroundImage3 additionalClassNames="absolute left-[40.92px] top-[10px]">
      <g clipPath="url(#clip0_6347_1011)" id="Icon">
        <path d={svgPaths.p319d7580} id="Vector" stroke="var(--stroke-0, #3D3D6B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
...
function QuietSpacePage28() {
  return (
    <div className="absolute h-[331.531px] left-[16px] top-[220px] w-[361px]" data-name="QuietSpacePage">
